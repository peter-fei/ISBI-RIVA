...
classes = ('NILM', 'ENDO', 'INFL', 'ASCUS', 'LSIL', 'HSIL', 'ASCH', 'SCC')  # 将 'defect' 替换为你实际的类别名
num_classes = 8
...
data_root = '/public_bme2/bme-wangqian2/jianght/Datas/ISBI-riva-cervical-cytology-challenge-track-a/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root + 'annotations/train_coco_seg.json',
        img_prefix=data_root + 'images/train/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        classes=classes, 
        ann_file=data_root + 'annotations/val_coco_seg.json',
...
model = dict(
    ...
    mask_head=dict(
        ...
        stage_num_classes=[8, 8, 8, 8],  # use class-agnostic classifier in the last stage
...
work_dir = '/public_bme2/bme-wangqian2/jianght/ckpts/ISBI_RIVA/A/co_detr_vit_instance'
